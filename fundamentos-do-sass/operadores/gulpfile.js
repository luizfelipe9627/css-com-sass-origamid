...
function html() {
  return (
    ...
    gulp
      ...
      // O pipe é responsável por executar as funções dentro dele, nesse caso está executando o concat que é responsável por concatenar os arquivos e passando o parâmetro header.html, que é o nome do arquivo que será gerado.
...
// O series é responsável por executar as funções passadas como parâmetro em sequência, nesse caso quando o comando gulp build for executado, irá executar as funções html e styles.
exports.build = gulp.series(html, styles);

// O parallel é responsável por executar as funções passadas como parâmetro em paralelo, nesse caso quando o comando gulp for executado, irá executar as funções html, styles, browser e sentinel.
